...
fn main() {
    ...
    App::new()
        ...
        .insert_resource(ObservationUnitTags::default())
            .insert_resource(crate::units::PendingBarInserts::default())
        ...
        .add_systems(PreUpdate, crate::units::apply_pending_bars)
        .add_systems(Update, cleanup_dead_units)
        .add_systems(PostUpdate, response_controller_system)
